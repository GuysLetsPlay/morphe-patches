...
<!-- PATCHES_START -->
> **[v1.40.0](https://github.com/GuysLetsPlay/morphe-patches/releases/tag/v1.40.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;139 patches total
<details>
...
| [Save debug log to file](#save-debug-log-to-file) | Adds a setting in Morphe settings under Misc to save the recent log messages to a file in the public Download folder. Useful for debugging without adb. |  |
